...
\newcommand{\prospettoSettimanale}{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Studio approfondito di Java e Spring
        \end{itemize}
        ...
        \end{itemize}
        \item \textbf{Quarta Settimana (32 ore)} 
        \begin{itemize}
...
\newcommand{\obiettiviObbligatori}{
     ...
     \item \underline{\textit{O04}}: Progettazione dell'architettura del sistema e definizione delle componenti software;
	 ...
	 \item \underline{\textit{O08}}: Sviluppo della schermata di dettaglio relativa a un singolo post. La schermata dovrà mostrare i contenuti e gli snippet di codice del post originale, l'autore del post e le interazioni da parte degli altri utenti iscritti alla piattaforma;
	 \item \underline{\textit{O09}}: Sviluppo delle funzionalità CRUD per i post;
	 \item \underline{\textit{O10}}: Sviluppo delle funzionalità CRUD per i commenti ai post;
	 ...
	 \item \underline{\textit{O13}}: Verifica della conformità del prodotto rispetto agli obiettivi prefissati.
}
